...
VERBOSITY_TEMPLATE = '''
Review the following text for better understanding. {% if recipe['verbosity'] == 'shorter' %}Reduce the number of sentences, while keeping the meaning of the text intact as much as possible.{% elif recipe['verbosity'] == 'longer' %}Expand on the message and go into detail when possible.{% endif %}
...
{% if 'flavor' in recipe %}
Do not forget to make the reviewed text {{ recipe['verbosity'] }}!
{% endif %}
'''
