presets = [
    ...
    },
    {
        ...
        "examples": [
            {"type": "positive", "value": "At sunset, the tranquil lake glowed warmly while a gentle breeze carried the scent of pine and wildflowers through the trees."},
            {"type": "negative", "value": "As the sun dipped below the horizon, casting a warm glow over the tranquil lake, a gentle breeze whispered through the trees, carrying the scent of pine and wildflowers."}
        ]
    },
    {
        "type": "text",
    ...
    },
    {
        ...
        "examples": [
            {"type": "positive", "value": "In my opinion, I believe that the meeting proceeded quite smoothly."},
            {"type": "negative", "value": "In my opinion, I believe that the Meeting proceeded quite smoothly."}
        ]
    },
    {
        "type": "text",
    ...
    },
    {
        ...
        "examples": [
            {"type": "positive", "value": "The seller provided excellent customer service."},
            {"type": "negative", "value": "The salesman provided excellent customer service."}
        ]
    },
    {
        "type": "text",
        ...
        "examples": [
            {"type": "positive", "value": "Let’s meet at 10 o’clock Coordinated Universal Time (UTC)."},
