...
class GeminiBase(LLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.endpoint = endpoint or "https://generativelanguage.googleapis.com/v1beta/models/{model_id}:generateContent"
    ...
    def _invoke(self, prompt: str | Messages) -> dict:
        ...
        try:
            ...
            if response.status_code != 200:
                raise ValueError(f"Error raise by Google Gemini service: {response.text}")
...
class Gemini(GeminiBase, MessagesMixin):
    ...
    def __init__(
            self, model_id: str, source: str | None = None, **kwargs
    ):
        """
